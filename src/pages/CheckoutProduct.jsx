...
export default function CheckoutProduct() {
  ...
  const estimatedOrder = qty * finalPrice;
  const estimatedTax = 4000;
  const estimatedSubtotal =
    estimatedOrder + estimatedTax + deliveryPrice;
            ...
            <div className="mt-4 rounded-lg bg-gray-50 p-4">
              ...
              <div className="flex justify-between py-1">
                ...
                <p className="font-bold">
                  Idr. {estimatedOrder.toLocaleString("id-ID")}
                </p>
              </div>
              ...
              <div className="flex justify-between py-1">
                <p>Tax</p>
                <p className="font-bold">
                  Idr. {estimatedTax.toLocaleString("id-ID")}
                </p>
              </div>
              ...
              <div className="flex justify-between">
                <p>Subtotal</p>
                <p className="font-bold">
                  Idr. {estimatedSubtotal.toLocaleString("id-ID")}
                </p>
              </div>

              <p className="mt-2 text-xs text-gray-500">
                *Final price will be calculated on checkout
              </p>
